# Partners and Certified Practitioners

Source: PARTNERSHIP_LEDGER.md (last updated 12 May 2026)

## Structure

- **IP owner:** Lewis James Burgess (personally) — the certification mark and IP remain with Lewis unless formally assigned
...
Never help institutions create, market, or sell "Burgess Principle compliant" products while still relying on automated decisions. Support individuals applying the framework. Redirect institutional requests seeking to badge unchanged automated pipelines.
