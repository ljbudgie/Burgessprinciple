...
| I want a ready-to-send adjustment letter for my specific disability (or an Easy Read version) | [`ACCESSIBILITY_REASONABLE_ADJUSTMENTS_WITH_BURGESS.md`](./ACCESSIBILITY_REASONABLE_ADJUSTMENTS_WITH_BURGESS.md) | Copy-paste letters for cognitive, mental health, energy-limiting, blind/low-vision, Deaf/HoH, speech, mobility, or carer-on-behalf-of |
