# THE BURGESS PRINCIPLE — LIVE FINDINGS LEDGER
...
| 48 | SSRN / Elsevier | Academic Publishing | **DISTRIBUTED** | — | Seven-paper series, all DISTRIBUTED on SSRN. Paper 4 — Differential Ire (6909118): attributable governance harms sustain accountability pressure; diffuse scandals do not. Paper 5 — SOVEREIGN Counsel (6913498): NULL drift in legal services, fractional models, self-represented litigant as owning mind. Paper 6 — The Sovereign Decline (6915798): restoring attributable judgment in professional engagement with patient-led innovation. Paper 7 — Cognitive Dissonance at Scale (7016721): how named-individual accountability breaks institutional rationalisation (distributed 14 July 2026). Series: 6759778 · 6864621 · 6894860 · 6909118 · 6913498 · 6915798 · 7016721. See papers/SSRN_INDEX.md for full machine-readable index. |
...
| 8 | Wave Utilities | Utilities | **SOVEREIGN** | 16/20 | Resolved — both accounts £0.00. £795.14 removed. Template SOVEREIGN outcome — Full case study CASE_STUDY_WAVE.md |
| 9 | iC&R | Debt Collection | **NULL** | 3/20 | Pulled back by Wave on resolution |
| 10 | Trading 212 UK Ltd | Financial Services | **NULL** | 2/20 | ICO complaint active |
| 11 | Apple Inc. | Technology | **NULL** | 1/20 | Pattern letter IC-4999654-T1Q8 |
| 12 | Phonak / Sonova UK Ltd | Medical Device | **NULL** | 1/20 | ICO + MHRA dual track active — CEC 253215 / MHRA FOI2026/00527 |
| 13 | TV Licensing / BBC | Public Broadcaster | **Partial Sovereign** | 12/20 | Enforcement ceased on record correction — DSAR pending |
| 14 | X / Twitter | Technology | **NULL** | 0/20 | Complete non-response — DSAR overdue |
| 15 | Vanquis Bank | Financial Services | **NULL** | 2/20 | FOS window open until September 2026 |
| 16 | Palantir | Technology | **Clean Negative** | N/A | No records found. Proper institutional response |
| 17 | HMPO | Government | **NULL (provisional)** | 1/20 | DSAR overdue |
| 18 | Reddit Inc. | Technology | **NULL** | 1/20 | Account restricted without human review — UK GDPR Article 22 |
| 19 | UK Home Office | Government | **NULL (provisional)** | 2/20 | FOI and DSAR active. Internal review filed June 2026 re Kanye West/Ye entry refusal — FOI2026/05301 / FOI2026/05685 |
| 20 | Information Commissioner's Office | Regulator | **NULL** | 1/20 | Pre-Action Protocol issued — IC-4999654-T1Q8 |
| 21 | HM Treasury | Government | **Pending** | 1/20 | FOI acknowledged — FOI2026/08366 |
| 22 | Cabinet Office | Government | **Pending** | 1/20 | FOI acknowledged — FOI2026/07744 / FOI2026/07733 |
| 23 | Food Standards Agency | Government | **Pending** | 4/20 | Substantive response received |
| 24 | OpenAI Ireland Limited | Technology | **NULL** | 1/20 | ICO complaint filed |
| 25 | Energy Ombudsman | Ombudsman | **NULL** | 1/20 | Both rulings declined. Disability omitted — EG021819-26 / EG037844-26 |
| 26 | Ofgem | Regulator | **NULL (provisional)** | 1/20 | Formal complaint filed |
| 27 | MHRA | Healthcare Regulator | **NULL (provisional)** | 1/20 | FOI2026/00527 active. Dual track ICO + MHRA — CEC 253215 |
| 28 | CDDFT ENT Audiology | NHS | **NULL (Accessibility)** | 0/20 | No working email route |
| 29 | NHS England AI Directorate | NHS | **NULL (Accessibility)** | 0/20 | Email bounced |
| 30 | DHSC | Government | **NULL (Accessibility)** | 0/20 | Email bounced |
| 31 | AI and Digital Regulations Service | Government | **NULL (Accessibility)** | 0/20 | Email bounced |
| 32 | Companies House | Government | **Pending** | — | Automated acknowledgement only — COH2041148X |
| 33 | Law Commission | Legal Reform | **Engagement** | — | Forwarded to Public Law team — 14th Programme of Law Reform |
| 34 | VWFS Financial Crime Team | Financial Services | **NULL** | — | ICO complaint filed 1 June 2026 — IC-521371-M3C2 / DBC-3571-26 |
...
- **British Gas — Dharmesh Rajput personal SOVEREIGN response (entry #81, SOVEREIGN 16/20).** 29 June 2026. The Director of Customer Service responded personally to the s.136 letter: both accounts (602181316 and BGB337948) confirmed on hold during Ombudsman investigation EG054013-26, and Anita Tomlin named as a dedicated point of contact going forward. Individual views disclaimer present in the footer. Four questions remain outstanding — named officer for enforcement visits, false statement of 17 June, Andrew Fletcher position, disability recording correction — all passed to Anita Tomlin. A named human applied individual consideration to the specific facts: SOVEREIGN. Contrast entry #66 (same institution, earlier NULL deadlock letter to the wrong address).
...
- **Connected by Data / Jeni Tennison — SOVEREIGN (entry #76).** Jeni Tennison (CEO) named — individual decision applied to certification inquiry 24 June 2026. Declined. SOVEREIGN classification stands: the binary test records process, not outcome. A named CEO's individual decision is SOVEREIGN regardless of the answer. An anonymous form rejection of the same inquiry would be NULL.
...
**One SOVEREIGN result.** Wave Utilities is the proof of concept: a named human reviewed the specific facts, both accounts were cleared to £0.00, and £795.14 was removed. It shows the framework identifies compliance as readily as its absence — and that the destination is reachable.

**Most significant NULL finding:** Birmingham Magistrates' Court — 536,139 warrants processed by CSV bulk upload (Fletcher admission: 5% dip sample, en bloc grant). This is the foundational case. No individual review of any single case is possible at that volume by that method.

**Most significant corroborating record:** The Local Government Ombudsman's published decision in case LGO 26000967 uses the phrase "without human consideration" — Burgess Principle language appearing in an official published regulatory record.

**Clean negative matters too:** Palantir returned no records and gave a proper institutional response. Recording it keeps the ledger honest and shows the test is not a one-way ratchet.

**Legal convergence:** findings are potentially relevant to:
...
**Framework reference:** NULL = starting point and diagnosis, not a verdict. SOVEREIGN = the destination. This ledger documents the journey — most of it not yet made, one stretch (Wave) already walked.
