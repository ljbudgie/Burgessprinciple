...
| Tier | Route | Typical Applicant | Core Commitment |
|------|-------|-------------------|-----------------|
| **Tier 1** | Institutional | Companies, public bodies, platforms, charities | Decision processes affecting identified individuals include real human scrutiny per the binary test. Requires named accountability officer, defined scope, licensing agreement, and periodic review. |
| **Tier 2** | Technology / Advocacy | AI tools, workflow platforms, law firms, claims groups | The Burgess gate is built into the product or client matter methodology before decision logic runs. Cannot be bypassed by prompts or process shortcuts. |
| **Tier 3** | Practitioner | Sole traders, advisers, community practitioners | Every client matter personally reviewed by a named human. |
...
4. Receive the full toolkit — Burgess Certified immediately
