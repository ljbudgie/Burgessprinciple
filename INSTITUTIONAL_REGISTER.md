...
## NEW FINDINGS FROM EMAIL AUDIT (27 April 2026)

The following institutions and developments were identified from inbox review and are not yet in the register:

1. **Equita Ltd** — enforcement agent for DBC council tax. SAR received (ID 405, 13 April 2026) but incomplete — no Liability Orders disclosed. Propensity score of 240 assigned via UK Search data (IDs 6159 and 71321). Contact after reasonable adjustment asserted (SMS sent same day). Complaint escalated by Kate Irwin, Complaints Officer, 24 April 2026. LGO complaint 26000967 already filed. **New institution — needs scoring.**

2. **Companies House** — contacted 26 April 2026 (ref COH2041148X). Automated acknowledgement only. Context unclear from snippet — likely connected to CCJ or company record queries. **Needs clarification.**

3. **Law Commission** — evidence submission sent 21 April 2026 re 14th Programme of Law Reform (public sector automated decision-making). Substantive response received 23 April 2026: forwarded to Public Law team for direct response. **Significant — first formal legal reform body engagement.** Not a NULL/SOVEREIGN test — categorised as Engagement.

4. **Councillor Stephen Harker (DBC Leader)** — direct personal approach 21 April 2026. Harker responded 22 April 2026 — confirmed PCN 4445032 will be treated as formal representation (28-day response window from 22 April = **deadline 20 May 2026**). Confirmed Pre-Action Protocol letter referred to Litigation team. Did not personally apply binary test — deflected to Downey and process. **Partial engagement — D1 scores 1, not SOVEREIGN.**

5. **DBC FOI DBC-3045-25** — FOI response received from Darlington Borough Council 24 April 2026 (freedomofinformation@darlington.gov.uk). Apology for delay noted. Content of response not yet reviewed — needs full assessment.

6. **WHOOP** — partnership outreach for OpenHear haptic wristband proposal sent 22 April 2026. Response 23 April 2026 directing to partnerships@whoop.com. Not a Burgess Principle institutional test — OpenHear ecosystem development. Logged for completeness.

7. **Treasury Committee** — submission sent 23 April 2026 re Digital Services Tax and automated systems. Auto-acknowledged. Not yet substantively engaged.
...
### 1. E.ON Next / E.ON Field Debt Solutions — NULL (1 / 20)
...
### 2. HMCTS / Birmingham Magistrates' Court — NULL (1 / 20)
...
**Response summary:** Andrew Fletcher (Justices' Legal Adviser) confirmed CSV batch applications, dip sampling 5/100, en bloc granting. 536,139 warrants in 18 months.
**Finding:** NULL — systemic. D1 scores 1: substantive direct answer confirming a systemic NULL.
**Status:** Admission documented. Submitted to Energy Ombudsman, Bureau of Investigative Journalism, Law Commission, ESNZ Committee.
...
### 5. Equita Ltd — NULL (provisional) ⭐ NEW ENTRY

**Sector:** Enforcement Agent / Debt Collection (acting for Darlington Borough Council)
**Date first contacted:** 6 March 2026
**SAR reference:** ID 405 (response received 13 April 2026)
**LGO complaint:** 26000967

| D1 | D2 | D3 | D4 | D5 | Total |
| --- | --- | --- | --- | --- | --- |
| 0 | 0 | 1 | 0 | 0 | 1 / 20 (provisional) |

**Question asked:** Was a named human being able to individually review the specific facts of each enforcement case (24277541 / 24371333 / 24519250 / 24618815 / 24650546 / 24696071) before enforcement action was taken?
**Response summary:** SAR ID 405 received 13 April 2026 but incomplete — no Liability Orders disclosed (foundational legal instruments for all council tax enforcement). Equita acknowledged the gap and stated it had requested copies from DBC. SAR due date per Equita's own system: **10 May 2026**. Delay in logging original request (6 March 2026 email not passed to relevant department until 10 April 2026) — referred to ICO. Complaint escalated by Kate Irwin (Complaints Officer, Equita/ColX Group) 24 April 2026.
**Equality Act failures documented:**
- SMS sent 6 March 2026 (same day reasonable adjustment asserted)
- Agent SMS sent 6 March 2026 (case 24618815)
- 20 March 2026 welfare response directed contact "via SMS" despite adjustment on file
- Vulnerability record ID 53935 (created 20 March 2026) recorded deafness as severe, yet directed SMS contact same day
- Welfare review 23 March 2026 conditioned reasonable adjustment on medical evidence via inaccessible channels — unlawful
**Propensity scoring:** UK Search data obtained; propensity score 240 assigned (IDs 6159 and 71321, dated 14 March 2025 and 14 November 2025). Lawful basis under UK GDPR Article 6 not provided. DBC authorisation for third-party propensity scoring not confirmed. Credit agency sharing not confirmed.
**Enforcement fee challenge:** Agent notes (Alan Hitchen, 16 September 2025) record visits across linked cases on same date. Single visit cannot lawfully generate enforcement fees on multiple cases. Body worn video references requested.
**Finding:** NULL (provisional) — enforcement without verified legal foundation (no Liability Orders disclosed), multiple Equality Act breaches, propensity scoring without confirmed lawful basis. Binary test: no named human being confirmed as having individually reviewed the specific facts of any of the six cases before enforcement action.
**Status:** SAR completion deadline 10 May 2026. Kate Irwin (Complaints Officer) has escalated. LGO complaint 26000967 active. ICO referral re SAR logging delay in progress.
...
**Finding:** NULL — automated closure. *Durkin v DSG Retail* applicable. **⚠️ ICO complaint ready to file — overdue. File immediately.**

---

### 7. Northumbrian Water — NULL (2 / 20)

| D1 | D2 | D3 | D4 | D5 | Total |
| --- | --- | --- | --- | --- | --- |
| 1 | 0 | 1 | 0 | 0 | 2 / 20 |

**Finding:** NULL — CCJ without evidenced contract. Weasel Response Detected. DSAR deadline **10 May 2026** (calendar set).

---

### 8. Wave Utilities — SOVEREIGN (16 / 20)

| D1 | D2 | D3 | D4 | D5 | Total |
| --- | --- | --- | --- | --- | --- |
| 4 | 4 | 3 | 4 | 1 | 16 / 20 |

**Finding:** SOVEREIGN. Both accounts cleared to £0.00. £795.14 removed. Template outcome. Full case study: `CASE_STUDY_WAVE.md`
...
**Finding:** NULL — data processor; no independent verification. Pulled back by Wave on resolution. D1 scores 2: direct, honest, confirmed NULL.

---

### 10. Trading 212 UK Ltd — NULL (2 / 20)

| D1 | D2 | D3 | D4 | D5 | Total |
| --- | --- | --- | --- | --- | --- |
| 1 | 0 | 1 | 0 | 0 | 2 / 20 |

**Finding:** NULL — Weasel Response Detected. Seven DSAR categories unanswered. Active ICO complaint. FCA referral ready.

---

### 11. Apple Inc. — NULL (1 / 20)

| D1 | D2 | D3 | D4 | D5 | Total |
| --- | --- | --- | --- | --- | --- |
| 0 | 0 | 1 | 0 | 0 | 1 / 20 |

**Finding:** NULL — template responses; six specific points unanswered. Part of pattern letter IC-4999654-T1Q8.

---

### 12. Phonak / Sonova UK Ltd — NULL (1 / 20)

| D1 | D2 | D3 | D4 | D5 | Total |
| --- | --- | --- | --- | --- | --- |
| 0 | 0 | 1 | 0 | 0 | 1 / 20 |

**Finding:** NULL — "algorithm does not process personal data" — legally unsustainable. Active ICO complaint. **Updated 27 April 2026:** MHRA safety concern filed 25 April 2026 (CEC 253215), acknowledged 27 April 2026. Dual-track: ICO + MHRA. Potentially most significant case in register for medical device precedent.

---

### 13. TV Licensing / BBC — Partial sovereign (12 / 20)

| D1 | D2 | D3 | D4 | D5 | Total |
| --- | --- | --- | --- | --- | --- |
| 3 | 2 | 3 | 3 | 1 | 12 / 20 |

**Finding:** Partial sovereign. Enforcement letters ceased on record correction. DSAR still pending.

---

### 14. X / Twitter — NULL (0 / 20)

| D1 | D2 | D3 | D4 | D5 | Total |
| --- | --- | --- | --- | --- | --- |
| 0 | 0 | 0 | 0 | 0 | 0 / 20 |

**Finding:** NULL — complete non-response. Deadline 6 April 2026 — **21 days overdue. ⚠️ File ICO complaint immediately.**

---

### 15. Vanquis Bank — NULL (2 / 20)

| D1 | D2 | D3 | D4 | D5 | Total |
| --- | --- | --- | --- | --- | --- |
| 1 | 0 | 1 | 0 | 0 | 2 / 20 |

**Finding:** NULL — "The Burgess Principle does not exist in UK law" — documented. FOS window open from 26 March 2026 — **act promptly, closes 26 September 2026.**

---

### 16. Palantir — Clean negative (N/A)

Searched systems; no records found. Proper institutional response. Documented as clean negative comparator.

---

### 17. HMPO — NULL (1 / 20, provisional)

| D1 | D2 | D3 | D4 | D5 | Total |
| --- | --- | --- | --- | --- | --- |
| 0 | 0 | 1 | 0 | 0 | 1 / 20 |

**Finding:** NULL (provisional). **⚠️ DSAR deadline 29 April 2026 — TOMORROW. No response found in inbox.**

---

### 18. Reddit Inc. — NULL (1 / 20)

| D1 | D2 | D3 | D4 | D5 | Total |
| --- | --- | --- | --- | --- | --- |
| 0 | 0 | 1 | 0 | 0 | 1 / 20 |

**Finding:** NULL — self-referential. Account restricted with no human review. UK GDPR Article 22.

---

### 19. UK Home Office — NULL (2 / 20, provisional)

| D1 | D2 | D3 | D4 | D5 | Total |
| --- | --- | --- | --- | --- | --- |
| 0 | 0 | 2 | 0 | 0 | 2 / 20 |

**Finding:** NULL (provisional). FOI FOI2026/05685 acknowledged. Deadline 20 May 2026. DSAR deadline ~21 May 2026.

---

### 20. Information Commissioner's Office — NULL (1 / 20)

| D1 | D2 | D3 | D4 | D5 | Total |
| --- | --- | --- | --- | --- | --- |
| 0 | 0 | 1 | 0 | 0 | 1 / 20 |

**Finding:** NULL — 33 days without acknowledgement. **Pre-Action Protocol deadline 4 May 2026. Hard litigation trigger in 7 days.** PHSO complaint submitted. Ref IC-4999654-T1Q8.

---

### 21. HM Treasury — Pending (1 / 20)

FOI FOI2026/08366 acknowledged. Deadline 20 May 2026.

---

### 22. Cabinet Office — Pending (1 / 20)

FOIs FOI2026/07744 and FOI2026/07733 acknowledged. Deadline 20 May 2026.

---

### 23. Food Standards Agency — Pending (4 / 20 provisional)

| D1 | D2 | D3 | D4 | D5 | Total |
| --- | --- | --- | --- | --- | --- |
| 1 | 0 | 3 | 0 | 0 | 4 / 20 |

Substantive response received 22 April 2026 — 6 working days. Full scoring pending letter review.

---

### 24. OpenAI Ireland Limited — NULL (1 / 20)

| D1 | D2 | D3 | D4 | D5 | Total |
| --- | --- | --- | --- | --- | --- |
| 0 | 0 | 1 | 0 | 0 | 1 / 20 |

SAR access failure — data confirmed ready; authentication error prevented access. No named individual engaged. ICO complaint filed 24 April 2026.

---

### 25. Energy Ombudsman — NULL (1 / 20)

| D1 | D2 | D3 | D4 | D5 | Total |
| --- | --- | --- | --- | --- | --- |
| 0 | 0 | 1 | 0 | 0 | 1 / 20 |

EG021819-26 closed — both rulings declined; omitted disability; directed telephone response. EG037844-26 — premature closure; reopening request filed 24 April 2026.

---

### 26. Ofgem — NULL (1 / 20, provisional)

| D1 | D2 | D3 | D4 | D5 | Total |
| --- | --- | --- | --- | --- | --- |
| 0 | 0 | 1 | 0 | 0 | 1 / 20 |

Formal scheme complaint filed 24 April 2026. Auto-acknowledged. ESNZ Committee holds evidence. Statutory clock running.

---

### 27. MHRA — NULL (1 / 20, provisional) ⭐ NEW ENTRY

**Sector:** Healthcare regulator
**Date contacted:** 25 April 2026
...
**Question asked:** Four questions on AutoSense OS (Phonak Naída M70-SP): (1) MDSW classification and clinical accountability; (2) whether Phonak's "algorithm does not process personal data" position is consistent with MHRA's MDSW framework; (3) whether atypical audiological profiles require individual clinician review of adaptive algorithm decisions; (4) adverse event reports re population-average calibration on atypical profiles. Separate Article 15 SAR also filed.
**Finding:** NULL (provisional). Acknowledged within 2 days. Substantive response pending.
**Deadlines:** MHRA 18-working-day target ~**14 May 2026**; Article 15 SAR statutory deadline ~**25 May 2026**.

---

### 28. CDDFT ENT Audiology — NULL (0 / 20, Accessibility)

| D1 | D2 | D3 | D4 | D5 | Total |
| --- | --- | --- | --- | --- | --- |
| 0 | 0 | 0 | 0 | 0 | 0 / 20 |

Email to audiology department bounced (25 April). Email to `complaints@cddft.nhs.uk` also bounced (25 April — confirmed from inbox). Equality Act failure at access layer. **⚠️ No working email route found — needs urgent alternative contact route.**

---

### 29. NHS England AI Directorate — NULL (0 / 20, Accessibility)

Inbox shut down and unmonitored. NHS England AI Lab formally closed 2025. No public email contact for successor function.

---

### 30. DHSC — NULL (0 / 20, Accessibility)

Email to `dhsc.correspondence@dhsc.gov.uk` bounced. No working contact route found.

---

### 31. AI and Digital Regulations Service — NULL (0 / 20, Accessibility)

Email to `digitalregulations@nice.org.uk` bounced. Multi-agency one-stop-shop unreachable by email.

---

### 32. Companies House ⭐ NEW ENTRY

**Sector:** Companies Registry
**Date contacted:** 26 April 2026
**Reference:** COH2041148X

| D1 | D2 | D3 | D4 | D5 | Total |
| --- | --- | --- | --- | --- | --- |
| 0 | 0 | 1 | 0 | 0 | 1 / 20 (provisional) |

**Status:** Automated acknowledgement only. Context of query not confirmed from inbox — likely connected to CCJ or company record. Substantive scoring pending response. **Needs clarification of query subject.**
...
**Date filed:** 30 March 2026
**Identity verified:** 1 April 2026 (secondary ID provided)
**Statutory deadline:** **30 April 2026 — TOMORROW**
...
| **Treasury Committee** | 23 April 2026 | Auto-acknowledged | Pending |
| **PACAC** | 26 April 2026 | Auto-acknowledged | Pending |
| **Bureau of Investigative Journalism** | 20 April 2026 | Pending editorial response | Pending |
| **Newsquest / Gavin Foster** | 22 April 2026 | Pending editorial response | Pending |
| **EHRC** | Prior | Case 16525912 — confirmed facts fit disability discrimination in writing | Confirmed — documented |
...
| --- | --- | --- |
| Lola McEvoy MP (Constituency MP, PPS to SCMS) | No substantive reply. Office sent police to complainant's home 30 March 2026. | Formal complaint documented. Durham Constabulary SAR filed (deadline 30 April 2026). Parliamentary Commissioner for Standards referral reserved. |
| Prime Minister's Office | Automated acknowledgements only. | On record. |
...
| JCHR | Contacted April 2026. | Awaiting response. |
| Treasury Committee | Auto-acknowledged 23 April 2026. | Pending. |
| PACAC | Auto-acknowledged 26 April 2026. | Pending. |
| Home Affairs Committee | Auto-acknowledged 20 April 2026. | On record. |
...
| 19 | Home Office | Government | 2 / 20 | NULL (provisional) |
| 1 | E.ON Next | Energy | 1 / 20 | NULL |
| 2 | HMCTS / Birmingham Magistrates' Court | Courts | 1 / 20 | NULL |
| 6 | Equifax | Credit reference | 1 / 20 | NULL |
| 11 | Apple Inc. | Consumer technology | 1 / 20 | NULL |
| 12 | Phonak / Sonova | Medical devices | 1 / 20 | NULL |
| 17 | HMPO | Identity documents | 1 / 20 | NULL (provisional) |
| 18 | Reddit Inc. | Social media | 1 / 20 | NULL |
| 20 | ICO | Regulator | 1 / 20 | NULL |
| 21 | HM Treasury | Government | 1 / 20 | Pending |
| 22 | Cabinet Office | Government | 1 / 20 | Pending |
| 24 | OpenAI Ireland Limited | AI / Consumer tech | 1 / 20 | NULL |
| 25 | Energy Ombudsman | Statutory redress | 1 / 20 | NULL |
| 26 | Ofgem | Energy regulator | 1 / 20 | NULL (provisional) |
| 27 | MHRA | Healthcare regulator | 1 / 20 | NULL (provisional) ⭐ NEW |
| 5 | Equita Ltd | Enforcement agent | 1 / 20 | NULL (provisional) ⭐ NEW |
| 32 | Companies House | Registry | 1 / 20 | Pending ⭐ NEW |
| 33 | Durham Police | Police | 1 / 20 | Pending ⭐ NEW |
| 14 | X / Twitter | Social media | 0 / 20 | NULL |
| 28 | CDDFT ENT Audiology | NHS / Medical devices | 0 / 20 | NULL (Accessibility) |
| 29 | NHS England AI Directorate | NHS / AI Governance | 0 / 20 | NULL (Accessibility) |
| 30 | DHSC | Government / Health | 0 / 20 | NULL (Accessibility) |
| 31 | AI and Digital Regs Service | Multi-agency | 0 / 20 | NULL (Accessibility) |
...
**SOVEREIGN: 1 of 32**
**Accessibility NULL: 4**
**New institutions this update: 4 (MHRA, Equita, Companies House, Durham Police)**
