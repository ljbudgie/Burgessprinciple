...
- **Framework version:** v2.6.2 (released 21 June 2026) — see [CHANGELOG.md](./CHANGELOG.md) for what changed.
...
| --- | --- | --- |
| [`institutional_register.csv`](./institutional_register.csv) | 58 institutions — Institution, Sector, Finding, Score, D1–D5, Status, Key_Reference | `https://raw.githubusercontent.com/ljbudgie/burgess-principle/main/institutional_register.csv` |
| [`live_findings_ledger.csv`](./live_findings_ledger.csv) | 66 chronological events — Date, Institution, Event_Type, Finding, Score, Reference, Notes | `https://raw.githubusercontent.com/ljbudgie/burgess-principle/main/live_findings_ledger.csv` |
